<template>
  <div>
    ...
    <div class="steps-content">
      ...
      />
      <!-- 项目参与单位 -->
      <Participants ref="participants" v-if="current === 2" @addCurrent="changeCurrent" :id="currentData.id" />
      <!-- 描述和附件 -->
      <Describe ref="describe" v-if="current === 3" :describeData="currentData" @choiceDataType="choiceDataType" />
    </div>
    <!-- 操作按钮 -->
