        ...
        <a-row type="flex" justify="space-between" align="top">
          ...
          <a-col :span="11">
            <a-form-item label="所在单位">
              <a-input allowClear v-decorator="['directorUnitId', validatorRules.directorUnitId]" placeholder="请输入">
              </a-input>
            </a-form-item>
          </a-col>
          <a-col :span="11">
        ...
        <a-row type="flex" justify="space-between" align="top">
          ...
          <a-col :span="11">
            <a-form-item label="通信地址">
              <a-input allowClear v-decorator="['linkCommunicationAddress']" placeholder="请输入"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
      </a-card>
...
export default {
  ...
  data() {
    return {
      ...
      validatorRules: {
        ...
        directorUnitId: { rules: [{ required: true, message: '所在单位不能为空' }] },
  ...
  methods: {
    ...
    dealParams(data, val) {
      ...
      data.directorUnitId = val.directorUnitId
      ...
      data.linkCommunicationAddress = val.linkCommunicationAddress
      return data
    },
  },
}
