...
export default {
  ...
  computed: {
    tagGroup() {
      return [...this.projectOwnershipText, ...this.processStatusText, ...this.ownershipYearText]
    },
  },
  created() {
  ...
  methods: {
    ...
    handleSearch() {
      ...
      let ownershipYear = this.ownershipYear
      ...
      let params = {
        ...
        ownershipYear: ownershipYear.toString(),
        searchKey: keyWord,
      }
