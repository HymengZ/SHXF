<template>
 ...
 -->
  <a-upload
    ...
    @preview="() => {}"
  >
    <div v-if="fileList.length < amount">
      <a-icon type="plus" style="font-size: 25px; color: #898989" />
      <div style="margin-top: 5px">{{ btnText }}</div>
    </div>
  </a-upload>
</template>
  ...
  data() {
    return {
      url: {
        ...
        addAttachment: '/fire/scienceAchieve/addAttachment',
        // 删除
        delete: '/fire/scienceAchieve/delete/attachment/',
      },
      headers: {},
      // 文件存放的地方
      fileList: [],
